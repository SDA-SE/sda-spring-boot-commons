    ...
    http.csrf(AbstractHttpConfigurer::disable)
        ...
        .headers(
            configurer -> {
              ...
              configurer.addHeaderWriter(new StaticHeadersWriter("X-Frame-Options", "DENY"));
              configurer.addHeaderWriter(new StaticHeadersWriter("X-XSS-Protection", "0"));
              configurer.addHeaderWriter(new StaticHeadersWriter("Referrer-Policy", "no-referrer"));
            });
  }
