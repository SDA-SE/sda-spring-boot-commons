...
import org.sdase.commons.spring.auth.opa.OpaRequestBuilder;
import org.sdase.commons.spring.auth.opa.OpaRestTemplateConfiguration;
 ...
 * org.sdase.commons.spring.auth.opa.OpaAccessDecisionVoter#OpaAccessDecisionVoter(boolean, String,
 * String, OpaRequestBuilder, RestTemplate, ApplicationContext, io.opentracing.Tracer)} and {@link
 ...
 * the class extends {@link org.sdase.commons.spring.auth.opa.AbstractConstraints} and is annotated
 * with {@link org.sdase.commons.spring.auth.opa.Constraints} it can be {@link
 * org.springframework.beans.factory.annotation.Autowired} in {@link
 ...
 * custom {@link org.sdase.commons.spring.auth.opa.extension.OpaInputExtension}s.
 *
