 ...
 *       org.sdase.commons.spring.jackson.Iso8601Serializer.WithMillis}{@code .class)}. If a
 *       specific field should be serialized with nanoseconds, it must be annotated with
 *       {@code @}{@link com.fasterxml.jackson.databind.annotation.JsonSerialize}{@code (using =
 *       }{@link org.sdase.commons.spring.jackson.Iso8601Serializer.WithNanos}{@code .class)}.
 * </ul>
 *
