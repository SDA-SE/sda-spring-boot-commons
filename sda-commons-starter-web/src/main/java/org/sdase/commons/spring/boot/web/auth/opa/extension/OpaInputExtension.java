 ...
 * the existing {@link org.sdase.commons.spring.boot.web.auth.opa.extension extensions} and instead
 * use the constraint feature to receive data from the policy decider and use it to decide based on
 * it in your service.
 *
