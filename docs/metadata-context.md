...
[`MetadataContext`](https://github.com/SDA-SE/sda-spring-boot-commons/blob/main/sda-commons-metadata-context/src/main/java/org/sdase/commons/spring/boot/metadata/context/MetadataContext.java)
